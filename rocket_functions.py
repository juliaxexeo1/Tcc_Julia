...
def apply_kernels(X, kernels):
    ...
    # Changed Max
    #Create output with 1 feature (max pooling)
    ...
    for i in prange(num_examples):
        ...
        for j in range(num_kernels):
            ...
            b1 = a1 + lengths[j]
            #Num of feauture to return (max pooling and PPV)
            b2 = a2 + 2
            #Changed Max
            # Num of feauture to return (max pooling)
            #b2 = a2

            #Here convolutions happens
